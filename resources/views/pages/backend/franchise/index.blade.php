        ...
        <div class="x_panel">
            ...
            <div class="page-title" style="border-bottom: none">
                ...
                <div class="col-md-12 page-title">
                    <form action="{{ route('franchise.filter') }}" method="POST" style="display: inline-table;">
                        {{ csrf_field() }}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p><strong>Emial: </strong>{{$result->email}}</p>
                                </td>  
                                <td>
                                ...
                                <td>
                                    <p><strong>Investment: </strong>{{$result->investment}}</p>
                                    <p><strong>Preferred to start: </strong>{{$result->prefertostart}}</p>
                                </td>
                                ...
                                <td>
                                    <a href="{{route('franchise.show', $result)}}" class="btn btn-primary btn-xs" target="_blank"><i class="fa fa-eye"></i> Details</a>   

                                    @if($action == 1)                                 

                                    <form action="{{route('franchise.change.status', $result)}}" method="POST" style="display: inline;">
                                        {{ csrf_field() }}
                                    ...
                                    @if($action ==5)
                                    <form action="{{route('franchise.destroy', $result)}}" method="POST" style="display: inline;">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
