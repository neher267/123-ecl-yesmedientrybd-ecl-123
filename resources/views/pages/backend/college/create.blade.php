            ...
            <div class="x_content">
                ...
                <form action="{{route($name.'.store')}}" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                    ...
                    <!-- <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input value="{{ old('display_order') }}"  type="text" id="display_order" name="display_order" class="form-control col-md-7 col-xs-12" placeholder="Ex: 50. range=0-10000">
                        </div>
                    </div> -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input value="{{ old('area') }}"  type="text" id="area" name="area" required class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input value="{{ old('meta_keyworks') }}"  type="text" id="meta_keyworks" name="meta_keyworks" required class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
