                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p><strong>Interested College: </strong>{{$inquiry->college}}</p>
                                    <p><strong>Passing Year: </strong>{{$inquiry->passing_year}}</p>
                                    <p><strong>NEET Score: </strong>{{$inquiry->neet_score}}</p>
                                </td>  
