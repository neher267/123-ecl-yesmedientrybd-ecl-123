...
<div class="slider-area slider-two">
    <div class="preview-2">
        <div id="nivoslider" class="slides">    
            <!-- <img src="{{ asset('public/frontend/img/slider/1.jpg') }}" alt="" title="#slider-1-caption1"/> -->
            <img src="{{ asset('public/frontend/img/slider/2.jpg') }}" alt="" title="#slider-1-caption2"/>
        </div> 
                            ...
                            <div class="text-content-wrapper">
                                <div class="text-content">
                                    ...
                                    <div class="banner-readmore hidden-sm hidden-xs">
                                        <a class="button-default bg-blue" href="{{ url('courses') }}">View Colleges We Represent</a>                 
                                    </div>
                                </div>
                            </div>
                        </div>
